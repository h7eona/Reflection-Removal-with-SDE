...
class LQGTDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        GT_size_h = self.opt["GT_size_h"]
        GT_size_w = self.opt["GT_size_w"]
        LR_size_h = self.opt["LR_size_h"]
        LR_size_w = self.opt["LR_size_w"]
        ...
        if self.opt["phase"] == "train":
            H, W, C = img_LR.shape
            assert LR_size_h == GT_size_h, "GT size does not match LR size"# // scale, "GT size does not match LR size"
            ...
            # LR and GT Resize
            img_LR = np.resize(img_LR, (LR_size_h, LR_size_w))
            img_GT = np.resize(img_GT, (GT_size_h, GT_size_w))
